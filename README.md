...
_Create and run a GitHub Actions workflow._ smile:_:smile:_:smile:_:smile:_

</header>

## Step 5: Trigger the workflow

_You've now added a fully functioning workflow to your repository! :smile:_:smile:_:smile:_
